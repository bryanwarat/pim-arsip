    ...
    <div class="container mt-4">
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Detail Surat Masuk: {{ $mail->mail_number }}</h4>
            </div>
            <a href="{{ route('incomingmail.index') }}" class="btn btn-secondary btn-sm">Kembali ke Daftar</a>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8">{{ \Carbon\Carbon::parse($mail->received_date)->format('d F Y') }}</dd>
                        </dl>
                    </div>
                    <div class="col-md-6">
                        <dl class="row">
                            ...
                            {{-- ASUMSI $createdBy sudah tersedia dari Controller --}}
                            ...
                            <dt class="col-sm-4">File Surat</dt>
                            <dd class="col-sm-8">
                                @if ($mail->file_path)
                ...
                <hr>
                <a href="{{ route('incomingmail.edit', $mail->id) }}" class="btn btn-warning">Edit Data</a>
            </div>
        </div>

        {{-- =============================================== --}}
        {{-- BAGIAN PREVIEW PDF BARU --}}
        {{-- =============================================== --}}
        @if ($mail->file_path)
            @php
                // Tentukan URL file publik
                $fileUrl = asset('storage/' . $mail->file_path);
                // Cek ekstensi file (ASUMSI file_path menyimpan path lengkap)
