...
@section('content')
    <div class="container mt-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('incomingmail.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('mail_date') is-invalid @enderror"
                                    id="mail_date" name="mail_date" value="{{ old('mail_date') }}" required>
                                @error('mail_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('received_date') is-invalid @enderror"
                                    ...
                                    value="{{ old('received_date', \Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                                @error('received_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- Field created_by akan diisi secara otomatis di Controller, tetapi kita perlu input tersembunyi untuk validasi --}}
                            <input type="hidden" name="created_by" value="{{ auth()->user()->id ?? 1 }}">

                        </div>
                    </div>

                    <button type="submit" class="btn btn-success mt-3">Simpan Surat Masuk</button>
