...
@section('title', 'Daftar Sifat Surat')
@section('meta_description', 'Halaman daftar Sifat Surat aplikasi arsip')
    ...
    <div class="container mt-4">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Daftar Sifat Surat</h4>
            </div>
            <a href="{{ route('mailclassification.create') }}" class="btn btn-primary btn-sm">Tambah Sifat Surat Baru</a>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            $('#classificationTable').on('click', '.btn-danger', function(e) {
                e.preventDefault();
