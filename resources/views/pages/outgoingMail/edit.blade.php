    ...
    <div class="container mt-4">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Edit Surat Keluar: {{ $mail->mail_number }}</h4>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('outgoingmail.update', $mail->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('destination') is-invalid @enderror"
                                    id="destination" name="destination" value="{{ old('destination', $mail->destination) }}"
                                    required>
                                @error('destination')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <button type="submit" class="btn btn-success mt-3">Perbarui Surat Keluar</button>
